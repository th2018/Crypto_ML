...
#there is a problem when converting "<" from factor to number
```{r}
c<-"/Users/owner/Desktop/crypto/cry"
setwd(c)
cc<-read.csv("narrowresult.csv",header=T
             #,sep="\t"
             )
dim(cc)

cc[cc$ResultMeasure.MeasureUnitCode=="ocyst/100L",]
cc[cc$ResultMeasure.MeasureUnitCode=="oocyst/10L",]
summary(cc[cc$ResultDetectionConditionText=="Not Detected",]$ResultMeasureValue) #183 NA
...
cc[cc$ResultMeasureValue==0,]$detect<-0
cc[as.character(cc$ResultMeasureValue)=="",]$detect<-0

cc<-cc[,c("ActivityStartDate","MonitoringLocationIdentifier","ResultDetectionConditionText"
          ,"CharacteristicName"
...
summary(cc[cc$detect==1,])

save(cc,file="/Users/owner/Desktop/crypto/crypto_201912/cc.Rdata")
```
...
save(cc_s,file="/Users/owner/Desktop/crypto/crypto_201912/cc_s.Rdata")
```
...
dim(USGS_cc3)
head(USGS_cc2)
save(USGS_cc2,file="/Users/owner/Desktop/crypto/crypto_201912/USGS_cc2.Rdata")
```
...
save(USGS_cc4,file="/Users/owner/Desktop/crypto/crypto_201912/USGS_cc4_2019.Rdata")
```

#load the data
```{r}
USGS_cc4_20190507<-load("/Users/owner/Desktop/crypto/crypto_201912/USGS_cc4_2019.Rdata")
...
save(USGS_cc4_lulc_CntlPlains_EastHghlnds_NorthEast_cry_ws,file="/Users/owner/Desktop/crypto/crypto_201912/USGS_cc4_lulc_all_ws.Rdata")

```

```{r}
USGS_cc4_lulc_all_ws<-load("/Users/owner/Desktop/crypto/crypto_201912/USGS_cc4_lulc_all_ws.Rdata")
...
save(stations,file="/Users/owner/Desktop/crypto/crypto_201912/stations.Rdata")

stations<-stations[!(stations$id %in% c(
#"USC00103760","USC00331905","USC00361920","USC00365902","USC00366233","USC00368668","USC00475474","USC00476764","USC00476922","USC00479046","USW00014813","USC00336949","USC00360861"
"USC00364611","USC00361726","USC00360457","USC00361726")),]
...
save(station_last_TMAX_TMIN_nearest,file="/Users/owner/Desktop/crypto/crypto_201912/station_last_TMAX_TMIN_nearest.Rdata")
```
...
summary(USGS_cc4_lulc_nearest)
save(USGS_cc4_lulc_nearest,file="/Users/owner/Desktop/crypto/crypto_201912/USGS_cc4_lulc_nearest.Rdata")
...
dim(USGS_cc4_lulc_nearest_tmin_rmna)
summary(USGS_cc4_lulc_nearest_tmin_rmna)
save(USGS_cc4_lulc_nearest_tmin_rmna,file="/Users/owner/Desktop/crypto/crypto_201912/USGS_cc4_lulc_nearest_tmin.Rdata")
...
save(USGS_cc4_lulc_nearest_tmin_rmna_tmax,file="/Users/owner/Desktop/crypto/crypto_201912/USGS_cc4_lulc_nearest_tmin_rmna_tmax.Rdata")
...
if (nrow(readNWISdv(siteNumbers = siteNo,
                     ...
                     endDate = end.date))>0)
{
 # print(nrow(readNWISdv(siteNumbers = siteNo,                     parameterCd = pCode,startDate = start.date,                     endDate = end.date)))
...
dim(USGS_cc4)
summary(as.numeric(USGS_cc4$storm))
head(USGS_cc4)
plot(USGS_cc4$storm,as.numeric(USGS_cc4$runoff))
                                
save(USGS_cc4,file="/Users/owner/Desktop/crypto/crypto_201912/USGS_cc4_20190507_2.Rdata")
```

```{r}
load("/Users/owner/Desktop/crypto/crypto_201912/USGS_cc4_20190507_2.Rdata")
...
USGS_cc4_lulc$Other<-USGS_cc4_lulc$lulc11+USGS_cc4_lulc$lulc31 +USGS_cc4_lulc$lulc52 +USGS_cc4_lulc$lulc71 +USGS_cc4_lulc$lulc90+ USGS_cc4_lulc$lulc95 #water #Barren # Shrubland   
...
USGS_cc4_lulc<-USGS_cc4_lulc[,c(53:56   #LULC
                                ,44,48 #TEMPERATURE
                                ,52 #SURFACE Q
                                ,31 #RUNOFF
                                ,25 #WATERSHED AREA
...
#the model
```{r}
model<-as.formula(paste(colnames(USGS_cc4_lulc)[10], "~",      paste(colnames(USGS_cc4_lulc)[c(1:9,11:21)], collapse="+"), #families
                        sep = ""))
...
water_gbm_lumped<- gbm(model,
            ...
            cv.folds=10, # that error occurs when you have variable levels that exist in the test set which don't exist in the training set.
             ...
             verbose="CV")
#jpeg(paste("/Users/owner/Desktop/crypto/crypto_201912/","lumped_perf",'.jpg',sep=''))
...
auc(roc_obj)
#jpeg(paste("/Users/owner/Desktop/crypto/crypto_201912/","roc_lumped",'.jpg',sep=''))
plot(roc_obj)
#dev.off()
...
```{r}
jpeg(paste("/Users/owner/Desktop/crypto/crypto_201912/","relative_influence",'.jpg',sep=''))
par(mar = c(5, 11, 1, 1))
summary(
 water_gbm_lumped , 
  cBars = 10,
...
jpeg(paste("/Users/owner/Desktop/crypto/crypto_201912/","Runoff",'.jpg',sep=''))
water_gbm_lumped %>%
...
jpeg(paste("/Users/owner/Desktop/crypto/crypto_201912/","Surface_runoff",'.jpg',sep=''))
water_gbm_lumped %>%
...
jpeg(paste("/Users/owner/Desktop/crypto/crypto_201912/","Max_temperature",'.jpg',sep=''))
water_gbm_lumped %>%
...
jpeg(paste("/Users/owner/Desktop/crypto/crypto_201912/","Min_temperature",'.jpg',sep=''))
water_gbm_lumped %>%
...
jpeg(paste("/Users/owner/Desktop/crypto/crypto_201912/","Developed",'.jpg',sep=''))
water_gbm_lumped %>%
...
jpeg(paste("/Users/owner/Desktop/crypto/crypto_201912/","Developed_Surface_runoff",'.jpg',sep=''))
water_gbm_lumped %>%
  partial(pred.var =  "Developed_Surface_runoff", n.trees = water_gbm_lumped$n.trees, grid.resolution = 100) %>%
  autoplot(rug = TRUE, train = training)+theme(axis.text=element_text(size=21),
        axis.title=element_text(size=24
                                #,face="bold"
                                ))
...
jpeg(paste("/Users/owner/Desktop/crypto/crypto_201912/","Forest",'.jpg',sep=''))
water_gbm_lumped %>%
...
jpeg(paste("/Users/owner/Desktop/crypto/crypto_201912/","Cultivated",'.jpg',sep=''))
water_gbm_lumped %>%
...
jpeg(paste("/Users/owner/Desktop/crypto/crypto_201912/","Watershed_Area",'.jpg',sep=''))
water_gbm_lumped %>%
...
jpeg(paste("/Users/owner/Desktop/crypto/crypto_201912/","Forest_Runoff",'.jpg',sep=''))
water_gbm_lumped %>%
...
```{r}
jpeg(paste("/Users/owner/Desktop/crypto/crypto_201912/","relative_influence_i",'.jpg',sep=''))
par(mar = c(5, 14, 1, 1))
summary(
 water_gbm_lumped , 
  cBars = 10,
