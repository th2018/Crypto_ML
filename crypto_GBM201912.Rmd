...
```{r}
USGS_cc5<-USGS_cc4
USGS_cc5$ocyst100L<-USGS_cc5$ResultMeasureValue

USGS_cc5[USGS_cc5$ResultMeasure.MeasureUnitCode=="oocyst/10L",]$ocyst100L<-10*USGS_cc5[USGS_cc5$ResultMeasure.MeasureUnitCode=="oocyst/10L",]$ResultMeasureValue
summary(USGS_cc5$ResultMeasureValue)
summary(USGS_cc5$ocyst100)
plot(USGS_cc5$ActivityStartDate,USGS_cc5$ocyst100L)
...
#USGS_cc5_by_month$month<-as.numeric(4,8,12,2,1,7,6,3,5,11,10,9)
...
#USGS_cc5_by_month[ is.na(USGS_cc5_by_month$Proportion) ,]$Proportion=as.numeric("-12")
#USGS_cc5_by_month[1 ,]$Proportion=as.numeric("-1")
#USGS_cc5_by_month[12 ,]$Proportion=as.numeric("-1")
jpeg("/Users/owner/Desktop/crypto/crypto_201912/month_detect.jpg")
plot(USGS_cc5_by_month$Month,USGS_cc5_by_month$Proportion ,xlab = "Month",ylab = "Proportion of Cryptosporidium +"
     #,ylim = c(0,1)
     )
dev.off()
...
USGS_cc4_lulc$Average_temperature <-( USGS_cc4_lulc$tmin+USGS_cc4_lulc$tmax)/2
...
#jpeg(paste("/Users/owner/Desktop/crypto/crypto_201912/","lumped_perf",'.jpg',sep=''))
gbm.perf(water_gbm_lumped)
save(water_gbm_lumped,file="/Users/owner/Desktop/crypto/crypto_201912/water_gbm_SIMPLE.Rdata")
...
jpeg(paste("/Users/owner/Desktop/crypto/crypto_201912/","Average_temperature",'.jpg',sep=''))
water_gbm_lumped %>%
  partial(pred.var =  "Average_temperature", n.trees = water_gbm_lumped$n.trees, grid.resolution = 100) %>%
